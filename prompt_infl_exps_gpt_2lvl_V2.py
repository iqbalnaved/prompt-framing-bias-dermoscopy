...
SYSTEM_PROMPT = (
    "You will evaluate the image using only objective evidence visible in the input image. " 
...
BASE_PROMPT = (
    ...
    "(more likely to be a nevus) to 5 (more likely to be a melanoma)."
)

JSON_INSTRUCTION = ' Reply in JSON only, no markdown fencing: {"score": <int 1-5>, "rationale": "brief reason"}'
...
# gpt5.4, without system prompt 

python prompt_infl_exps_gpt_2lvl_V2.py --model gpt-5.4-2026-03-05 --data_dir /mnt/d/Naved/Data/ISIC99/images/originals --run 1 --savedir /mnt/d/Naved/Outputs/prompt_influence/gpt5.4-2lvl-orig-scr5/ --prompt_type T0
python prompt_infl_exps_gpt_2lvl_V2.py --model gpt-5.4-2026-03-05 --data_dir /mnt/d/Naved/Data/ISIC99/images/originals --run 1 --savedir /mnt/d/Naved/Outputs/prompt_influence/gpt5.4-2lvl-orig-scr5/ --prompt_type M1
python prompt_infl_exps_gpt_2lvl_V2.py --model gpt-5.4-2026-03-05 --data_dir /mnt/d/Naved/Data/ISIC99/images/originals --run 1 --savedir /mnt/d/Naved/Outputs/prompt_influence/gpt5.4-2lvl-orig-scr5/ --prompt_type B1

# gpt5.4, with system prompt 

python prompt_infl_exps_gpt_2lvl_V2.py --model gpt-5.4-2026-03-05 --data_dir /mnt/d/Naved/Data/ISIC99/images/originals --run 1 --savedir /mnt/d/Naved/Outputs/prompt_influence/gpt5.4-2lvl-orig-scr5/ --prompt_type T0  --use_system
python prompt_infl_exps_gpt_2lvl_V2.py --model gpt-5.4-2026-03-05 --data_dir /mnt/d/Naved/Data/ISIC99/images/originals --run 1 --savedir /mnt/d/Naved/Outputs/prompt_influence/gpt5.4-2lvl-orig-scr5/ --prompt_type M1  --use_system
python prompt_infl_exps_gpt_2lvl_V2.py --model gpt-5.4-2026-03-05 --data_dir /mnt/d/Naved/Data/ISIC99/images/originals --run 1 --savedir /mnt/d/Naved/Outputs/prompt_influence/gpt5.4-2lvl-orig-scr5/ --prompt_type B1  --use_system

-----------------

# gpt5, without system prompt 

python prompt_infl_exps_gpt_2lvl_V2.py --model gpt-5-2025-08-07 --data_dir /mnt/d/Naved/Data/ISIC99/images/originals --run 1 --savedir /mnt/d/Naved/Outputs/prompt_influence/gpt5-2lvl-orig-scr5/ --prompt_type T0
python prompt_infl_exps_gpt_2lvl_V2.py --model gpt-5-2025-08-07 --data_dir /mnt/d/Naved/Data/ISIC99/images/originals --run 1 --savedir /mnt/d/Naved/Outputs/prompt_influence/gpt5-2lvl-orig-scr5/ --prompt_type M1
python prompt_infl_exps_gpt_2lvl_V2.py --model gpt-5-2025-08-07 --data_dir /mnt/d/Naved/Data/ISIC99/images/originals --run 1 --savedir /mnt/d/Naved/Outputs/prompt_influence/gpt5-2lvl-orig-scr5/ --prompt_type B1

# gpt5, with system prompt 

python prompt_infl_exps_gpt_2lvl_V2.py --model gpt-5-2025-08-07 --data_dir /mnt/d/Naved/Data/ISIC99/images/originals --run 1 --savedir /mnt/d/Naved/Outputs/prompt_influence/gpt5-2lvl-orig-scr5/ --prompt_type T0  --use_system
python prompt_infl_exps_gpt_2lvl_V2.py --model gpt-5-2025-08-07 --data_dir /mnt/d/Naved/Data/ISIC99/images/originals --run 1 --savedir /mnt/d/Naved/Outputs/prompt_influence/gpt5-2lvl-orig-scr5/ --prompt_type M1  --use_system
python prompt_infl_exps_gpt_2lvl_V2.py --model gpt-5-2025-08-07 --data_dir /mnt/d/Naved/Data/ISIC99/images/originals --run 1 --savedir /mnt/d/Naved/Outputs/prompt_influence/gpt5-2lvl-orig-scr5/ --prompt_type B1  --use_system
